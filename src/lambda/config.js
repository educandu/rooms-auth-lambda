...
export const X_ROOMS_AUTH_SECRET = process.env.X_ROOMS_AUTH_SECRET;
if (!X_ROOMS_AUTH_SECRET) {
  throw new Error('Environment variable X_ROOMS_AUTH_SECRET is not defined');
}
